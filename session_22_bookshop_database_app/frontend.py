...
def view_command():
    list1.delete(0,END) # Delete all from index 0 to END
    for row in backend.view():
        list1.insert(END,row) # News row will be put in the END of the list
...
def get_selected_row(event):
    try:
        ...
        pass # Will fix the ListBox Empty List User Click
